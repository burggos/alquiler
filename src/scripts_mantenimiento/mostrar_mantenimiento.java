...
public class mostrar_mantenimiento {
    ...
    public void MostrarVehiculos(JTable tabla) {
        ...
        String sql =
            ...
            "WHERE v.estado IN ('Dañado', 'Mantenimiento') " +
        ...
        try {
            ...
            while (rs.next()) {
                ...
                modelo.addRow(new Object[]{
                    ...
                    rs.getString("estado"),
                    rs.getString("id_devolucion") != null ? rs.getString("id_devolucion") : "",
            ...
            JOptionPane.showMessageDialog(null, "Error al mostrar vehículos:\n" + e.getMessage());
        } finally {
            try {
                if (rs != null) rs.close();
                if (st != null) st.close();
